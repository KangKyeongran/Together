...
public class GoodbyeSelectActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        goto_goodbypet_gallery.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(GoodbyeSelectActivity.this, com.example.together.activities.goodbyePet.GoodbyeMemorialActivity.class );
                startActivity(intent);
            }
        });
        ...
        goodbyePet_how_to_use.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(GoodbyeSelectActivity.this, com.example.together.activities.goodbyePet.GoodbyeHowActivity.class );
                startActivity(intent);
            }
        });
